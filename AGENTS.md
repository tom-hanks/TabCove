# AGENTS.md -- TabCove: Setup & Onboarding Guide for Coding Agents

You're installing **TabCove** for the user. Your job is not just to set it up -- it's to get them excited about using it.
...
> **TabCove** replaces your new tab page with a clean dashboard of everything you have open, grouped by domain.
>
...
>
> You should see "TabCove" appear in your extensions list.
...
> You're all set! Open a **new tab** and you'll see TabCove.
>
> Here's how it works:
...
- TabCove is a pure Chrome extension. No server, no Node.js, no npm.
